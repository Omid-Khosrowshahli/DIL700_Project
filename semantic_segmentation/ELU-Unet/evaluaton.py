...
from assets import labels, conf_mat_labels
...
def main(options):
    ...
    with torch.no_grad():
        ...
        conf_mat_display = ConfusionMatrixDisplay.from_predictions(y_true, y_predicted, normalize="true", display_labels=conf_mat_labels)
